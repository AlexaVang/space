        ...
        <nav className="navbar">
          <ul>
            ...
            <li className="list-item">
              <Link
                to="/destination"
                className="lg:text-white lg:flex lg:items-center"
              >
                <span className="lg:text-4xl lg:font-bold mr-2">01</span>{" "}
                Destination
              </Link>
            </li>
            <li className="list-item">
            ...
            <li className="list-item">
              <Link
                ...
                className="lg:text-white lg:flex lg:items-center"
              >
                <span className="lg:text-4xl lg:font-bold mr-2">03</span>{" "}
                Technology
              </Link>
            </li>
          </ul>
